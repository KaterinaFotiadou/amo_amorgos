...
class _HomePageState extends State<HomePage> with TickerProviderStateMixin {
  ...
  int _visibleCount(int total, [int limit = kPreviewCount]) =>
            ...
            children: [
                ...
                children: [
                  SizedBox(
                    ...
                    child: CachedNetworkImage(
                      imageUrl:
                      "https://firebasestorage.googleapis.com/v0/b/amorgosechoes.firebasestorage.app/o/yorgos-triantafyllou-kSZHnpXF7Eg-unsplash.jpg?alt=media&token=6c7350fc-0812-4526-b3c7-903fb5a02ec6",
                      fit: BoxFit.cover,
                ...
                child: TabBarView(
                  ...
                  children: [
                    ...
                    Builder(builder: (context) {
                      final totalBeaches = widget.beaches.length;
                      final visibleBeaches = _visibleCount(totalBeaches);

                      return ListView.builder(
                        scrollDirection: Axis.horizontal,
                        itemCount: visibleBeaches,
                              ...
                              Navigator.push(
                                ...
                                MaterialPageRoute(
                                  builder: (_) => DetailPage(
                                    name: beach.name[locale] ??
                                        beach.name['en'] ??
                                        '',
                                    imageUrl: beach.imageUrl,
                                    description: beach.description[locale] ??
                                        beach.description['en'] ??
                                        '',
                    ...
                    FutureBuilder<List<Sight>>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        final visible = _visibleCount(sights.length);
                            ...
                            return GestureDetector(
                              onTap: () {
                                Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                    builder: (_) => DetailPage(
                                      name: sight.name[locale] ??
                                          sight.name['en'] ??
                                          '',
                                      imageUrl: sight.imageUrl,
                                      description: sight.description[locale] ??
                    ...
                    FutureBuilder<List<Food>>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        final visible = _visibleCount(foodList.length);
                    ...
                    FutureBuilder<List<Stores>>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        final visible = _visibleCount(storesList.length);
                    ...
                    FutureBuilder<List<PlacesToStay>>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        final visible = _visibleCount(placesList.length);
                ...
                builder: (context, snapshot) {
                  ...
                  return SizedBox(
                    ...
                    child: ListView.builder(
                      scrollDirection: Axis.horizontal,
                      itemCount: items.length, // εδώ κρατάμε όλα
                      itemBuilder: (_, index) {
                        ...
                        return GestureDetector(
                          onTap: () {
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                builder: (_) =>
                                    ExploreDetailPage(category: item.title),
                              ),
                            );
                          },
                          child: Container(
              ...
              FutureBuilder<List<ExploreDetailItem>>(
                ...
                builder: (context, snapshot) {
                  ...
                  final visible = _visibleCount(offerItems.length);
                  ...
                  return SizedBox(
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        final title =
                            offer.name[locale] ?? offer.name['en'] ?? '';
...
// Widget για tip κάρτες (παραμένει ίδιο)
class TipCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      width: (MediaQuery.of(context).size.width - 56) / 2, // 2 ανά σειρά
