...
class _FavoritesPageState extends State<FavoritesPage> {
 ...
 //favoriten laden 
  ...
  Future<List<ExploreDetailItem>> _getFavorites() async {
    final favoriteIds = await FavoritesManager.getFavorites(); //ids laden
    final allItems = await _fetchAllItemsFromAllCollections(); //alle inhalte laden 

    return allItems.where((item) {
      final id = getItemId(item);
      return id.isNotEmpty && favoriteIds.contains(id); //nur gemerkte inhalte anzeigen 
    }).toList();
  }
